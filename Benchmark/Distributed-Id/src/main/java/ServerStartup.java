...
public class ServerStartup {
    ...
    public static void main(String[] args) {
        ...
        if (args != null && args.length == 2) {
            ...
            logger.warn(">>>>>You don't appoint the datacenterId and machineId argement,will use default value");
        }
        ...
        logger.info(String.format(new Date().getTime()+">>>>>Server start success, SnowFlake datacenterId is %d, machineId is %d",
                datacenterId,
                machineId
        ));
