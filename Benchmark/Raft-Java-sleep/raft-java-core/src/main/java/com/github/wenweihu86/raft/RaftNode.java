...
public class RaftNode {
    ...
    public RaftNode(RaftOptions raftOptions,
                    ...
                    StateMachine stateMachine) throws InterruptedException {
...
//            raftLog.updateMetaData(currentTerm, null, raftLog.getFirstLogIndex());
    ...
    public void appendEntries(Peer peer) throws InterruptedException {
        Thread.sleep(300);//threadsleep
     ...
     */
    private void startPreVote() throws InterruptedException {
        Thread.sleep(300);//threadsleep
        lock.lock();
        try {
    ...
    private boolean installSnapshot(Peer peer) throws InterruptedException {
