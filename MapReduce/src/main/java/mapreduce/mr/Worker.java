...
public class Worker {
    ...
    /**
     * Create temp write mapreduce.files.
     * @param fileId
     * @param reduceId
     * @return File object.
     * @throws IOException
    ...
    private File createWriteFile(int fileId, int reduceId) throws Exception {
        ...
        if (tempDirFile.isDirectory()){
            File writeFile = new File(tempDirFile.getAbsoluteFile() + File.separator + "mapreduce.mr-temp-" + fileId + "-" + reduceId);
            if(!writeFile.exists()){
    ...
    /**
     * Get reduce input mapreduce.files.
     * @param fileId
     * @param reduceId
     * @return File object.
     * @throws Exception
    ...
    private File getReadFile(int fileId, int reduceId) throws Exception {
        String userDir = System.getProperty("user.dir");
        File readFile = new File(userDir + File.separator + "output" + File.separator + "temp" + File.separator + "mapreduce.mr-temp-" + fileId + "-" + reduceId);
        if (readFile.exists()){
            return readFile;
        }else {
    ...
    private File getOutputFile(int RIndex) throws IOException {
        String userDir = System.getProperty("user.dir");
        File outputFile = new File(userDir + File.separator + "output" + File.separator + "mapreduce.mr-out-" + RIndex);
